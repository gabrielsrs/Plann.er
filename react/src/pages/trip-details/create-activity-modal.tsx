        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
            ...
            <form onSubmit={createActivity} className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <input type="datetime-local"name="occurs-at" placeholder="Data e Horário da atividade" className="bg-transparent text-lg placeholder-zinc-400 w-40 outline-none flex-1"/>
                </div>
                </div>
